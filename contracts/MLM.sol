...
contract MLM {
    ...
    function distributeLevelReward() public {
        ...
        for (uint256 i = 0; i < levelWinners.length; i++) {
            ...
            if(_inviter == address(0)){
                ownerAmount += (recyclePrice+levelPrice);
            }
            else{
