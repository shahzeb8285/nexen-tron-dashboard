...
class ReferalIncomeChart extends React.Component {
  ...
  render() {
    ...
    return (
              <Widget
                title={<h3>Level Wise <span className='fw-semi-bold'>Income</span></h3>}
              >
             {this.state.chartData?   <ApexChart 
                  className="sparkline-chart" 
                  height={350} 
                  series={this.state.chartData.apex.column.series}
                  options={this.state.chartData.apex.column.options}
                  type={"bar"}
                />:null}
...
export default ReferalIncomeChart;
