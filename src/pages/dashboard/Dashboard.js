        ...
        <div className={s.root}>
          <Widget>
            <Row>
              ...
              <Col size={3}>
                {this.props.user.totalUsers ? <Counter title={"ALL PARTICIPANTS"}
              ...
              <Col size={3}>
                {this.props.user.totalUSDAmountDistributed ? <Counter title={"JOINED IN 24 HOURS"}
                  counts={this.props.user ? this.props.user.totalUSDAmountDistributed : 0} />
                  : null}
              </Col>


              <Col size={3}>
                {this.props.user.totalUSDAmountDistributed ? <Counter title={"Distribution Amount(USD)"}
                  counts={this.props.user ? this.props.user.totalUSDAmountDistributed : 0} />
                  : null}
              </Col>
              ...
              <Col size={3}>
                {this.props.user.totalAmountDistributed ? <Counter title={"Distribution Amount(TRX)"}
                  counts={this.props.user ? this.props.user.totalAmountDistributed : 0} />
                  : null}
              </Col>
          ...
          <Row style={{ alignItems: "baseline" }}
            ...
            <Col size={9} nogutters>
              ...
              <SecondRewardWallet
                levelRewardWallet={
                  this.props.user.levelRewardWallet ? this.props.user.levelRewardWallet : null
                }
                rewardWallet={
                  this.props.user.rewardWallet ? this.props.user.rewardWallet : null
                }
                refPercent={
